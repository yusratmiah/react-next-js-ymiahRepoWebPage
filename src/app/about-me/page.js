...
export default async function Page() {
    ...
    return (
        <main>
            ...
            I am a third-year undergraduate student (senior by credits) pursuing a degree in Computer Science at Virginia Tech. I am passionate about developing efficient, data-driven applications and innovative solutions. Outside of academics, I serve as a Residential Advisor for the Innovate Living-Learning Community located in CID, where I foster an inclusive and collaborative environment. I enjoy alternative music, painting, and minimalism, and I am also interested in web development. Recently, I have expanded my skill set by learning frameworks and technologies such as Bootstrap, React, Next.js, and Vite. I am always eager to connect with peers and professionals to exchange ideas and explore opportunities for growth.
            </p>
